...
class Reset_Pass (tk.Frame):
    def __init__(self, master):
        ...
        # Confirm Password
        self.verification_label = tk.Label(self.forgot_password_label_bg, text="Confirm New Password", font=('Courier', 15), fg='white', bg='#3C3633')
        self.verification_label.place(x = 85, y= 290)
        
        self.verification_entry = tk.Entry(self.forgot_password_label_bg, font=('Courier', 12), fg='white', bg='#59504b')
        self.verification_entry.place(x= 100, y= 325)

        #cont button
        self.continue_button = CTkButton(self.forgot_password_label_bg, text="Continue", width=200, height=40, corner_radius=30, font=('Courier', 15, 'bold'), bg_color='#3C3633', fg_color='#E0CCBE', text_color='black',command=self.go_to_login)
        self.continue_button.place( x =100, y = 440)
